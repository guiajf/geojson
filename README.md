...
Para visualizar o mapa interativo com diferentes métodos de classificação clique [aqui](https://metodos-tawny.vercel.app/).<br>
Para visualizar o mapa interativo com os dados em escala logarítmica clique [aqui](https://maplog-sigma.vercel.app/).
